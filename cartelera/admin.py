...
class PeliculaAdmin(admin.ModelAdmin):
    list_display = ('titulo', 'genero', 'duracion', 'fecha_lanzamiento')
...
class FuncionAdmin(admin.ModelAdmin):
    list_display = ('pelicula', 'sala', 'hora', 'fecha_inicio', 'fecha_fin', 'tipo_funcion', 'precio')
    search_fields = ('pelicula__titulo', 'sala__nro_sala')
    list_filter = ('tipo_funcion', 'fecha_inicio', 'fecha_fin')
    ordering = ('fecha_inicio', 'hora')
...
class VentaAdmin(admin.ModelAdmin):
    ...
    ordering = ('fecha_venta', 'funcion__fecha_inicio')
